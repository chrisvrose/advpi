...
class TimerIOHandler : public MMIOHandler {
   ...
   private:
    ...
    void dispatchTimerReloadWrite(uint8_t timer_id, uint16_t value);
   ...
   public:
    ...
    /// Copy timer state out for visibility
    void copyTimerState(Timer outTimers[4]) {
        memcpy(outTimers, this->timers,sizeof(timers));
    }
