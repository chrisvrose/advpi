...
bool testConvertToLittleEndian3() {
...
int main() {
    std::vector<std::function<bool()>> tests {testConvertToLittleEndian1, testConvertToLittleEndian2, testConvertToLittleEndian3};
